...
import pom_Flipkart.product2;

public class pom_Runnerclass extends Flipkart_Base_Class {
	...
	Wait();
	    ...
	    System.out.println("iphone price1 "+fp.getIphonePrice1());
	     ...
	     sleep();  		
	  		...
	  		product2 p = new product2(driver);
...
//			
			System.out.println("Product2 iphone price:" + 	get_Text(p.getIphone2Price()));
		
			String price2 = 	get_Text(p.getIphone2Price()).replaceAll("[₹,]", "");
